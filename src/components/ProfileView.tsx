      ...
      {isPrivate ? (
        ...
        <>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-[minmax(0,1fr)_minmax(320px,0.85fr)] gap-6">
              <div className="rounded-[28px] border border-[#EAE4D9]/10 bg-[#1A1816] p-5 sm:p-8">
                <div className="flex items-end justify-between gap-4 mb-5">
                  <div>
                    <h3 className="font-serif text-2xl text-[#EAE4D9] mb-2">Flavor DNA</h3>
              ...
              <div className="space-y-6">
                {proofBadge && (
                  <div className="rounded-[28px] border border-[#C89B3C]/16 bg-[#1A1816] p-5 sm:p-7">
                    <h3 className="font-serif text-lg text-[#EAE4D9]/70 mb-4">Proof Tolerance</h3>
                ...
                <div className="rounded-[28px] border border-[#EAE4D9]/10 bg-[#1A1816] p-5 sm:p-7">
                  <h3 className="font-serif text-lg text-[#EAE4D9]/70 mb-4">Flavor Hallmarks</h3>
                  <div className="space-y-3">
          ...
          <div className="space-y-8">
            <div className="flex items-end justify-between gap-4">
              <div>
                <h2 className="font-serif text-2xl font-normal text-[#EAE4D9]">Journal</h2>
              </div>
