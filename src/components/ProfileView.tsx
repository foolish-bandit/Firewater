  ...
  return (
    <div className="experience-page animate-in fade-in duration-500">
                ...
                <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
                  <div className="space-y-3 min-w-0">
                    <div className="space-y-2">
                      ...
                      <h1 className="font-serif text-3xl sm:text-5xl font-normal text-[#EAE4D9] break-words">{profile.name}</h1>
                    </div>
                      ...
                      <div key={pillar.title} className="rounded-[24px] border border-[#EAE4D9]/10 bg-[#EAE4D9]/[0.03] p-4 text-left">
                        <div className="flex items-start gap-3">
                          ...
                          <div className="space-y-1 min-w-0">
                            ...
                            <p className="font-serif text-lg leading-tight text-[#EAE4D9] break-words">{pillar.value}</p>
          ...
          <div className="rounded-[28px] border border-[#C89B3C]/16 bg-[#120F0D]/85 p-5 sm:p-6">
            <div className="flex items-center justify-between gap-3 mb-4">
              <div>
                ...
                <h2 className="font-serif text-2xl text-[#EAE4D9]">Collector Signal</h2>
              </div>
            ...
            <div className="flex flex-wrap items-center justify-center md:justify-start gap-3 sm:gap-4 text-sm">
              {profile.favorite_spirit && (
                <span className="px-3 py-1 bg-[#C89B3C]/10 text-[#C89B3C] text-xs font-semibold tracking-[0.12em] uppercase border border-[#C89B3C]/20 rounded-full">
                  {profile.favorite_spirit}
                </span>
              )}
              {proofBadge && (
                <span className="px-3 py-1 bg-[#C89B3C]/5 text-[#C89B3C]/80 text-xs font-semibold tracking-[0.12em] uppercase border border-[#C89B3C]/15 rounded-full flex items-center gap-1.5" title={proofBadge.description}>
      ...
      <section className="experience-meta">
        <div className="experience-meta-grid grid-cols-3 sm:grid-cols-5 gap-2 sm:gap-3">
        <div className="experience-meta-card inset text-center">
          <span className="block font-serif text-xl sm:text-2xl text-[#EAE4D9]">{profile.tried_count}</span>
          <span className="meta-eyebrow text-[#C89B3C] mt-1 text-[8px] sm:text-[0.65rem]">Tasted</span>
        </div>
        <div className="experience-meta-card inset text-center">
          <span className="block font-serif text-xl sm:text-2xl text-[#EAE4D9]">{profile.want_count}</span>
          <span className="meta-eyebrow text-[#C89B3C] mt-1 text-[8px] sm:text-[0.65rem]">Wishlist</span>
        </div>
        <div className="experience-meta-card inset text-center">
          <span className="block font-serif text-xl sm:text-2xl text-[#EAE4D9]">{profile.review_count}</span>
          <span className="meta-eyebrow text-[#C89B3C] mt-1 text-[8px] sm:text-[0.65rem]">Reviews</span>
        </div>
        <button
          onClick={() => setShowFollows('followers')}
          className="experience-meta-card inset text-center hover:border-[#C89B3C]/30 transition-colors"
        >
          <span className="block font-serif text-xl sm:text-2xl text-[#EAE4D9]">{profile.follower_count}</span>
          <span className="meta-eyebrow text-[#C89B3C] mt-1 text-[8px] sm:text-[0.65rem]">Followers</span>
        </button>
        <button
        ...
        >
          ...
          <span className="meta-eyebrow text-[#C89B3C] mt-1 text-[8px] sm:text-[0.65rem]">Following</span>
        </button>
        </div>
      </section>

      {isPrivate ? (
        <div className="experience-meta-card inset border-dashed text-center">
        ...
        <>
          {topShelfLiquors.length > 0 && (
            <section className="experience-support">
              ...
              <div>
                <p className="section-kicker mb-2">Favorites</p>
          ...
          {flavorDNA && (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-[#1A1816] vintage-border p-5 sm:p-8">
                <h3 className="section-kicker mb-4 sm:mb-6">Flavor DNA</h3>
                <p className="text-[#EAE4D9]/40 text-xs mb-4 font-serif italic">Aggregate palate based on {triedIds.length} tasted liquor{triedIds.length !== 1 ? 's' : ''}</p>
              ...
              <div className="space-y-6">
                {proofBadge && (
                  <div className="bg-[#1A1816] vintage-border p-5 sm:p-8">
                    <h3 className="section-kicker mb-4">Proof tolerance</h3>
                ...
                {profile.avg_rating && (
                  <div className="bg-[#1A1816] vintage-border p-5 sm:p-8">
                    <h3 className="section-kicker mb-4">Average rating</h3>
                    <div className="flex items-center gap-4">
          ...
          {/* Tasting Journal */}
          <section className="experience-support">
          <div className="space-y-8 experience-support-block">
            <div>
              <p className="section-kicker mb-2">Tasting notes</p>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
                {recentReviews.map((review, index) => (
                  ...
                  >
                    ...
                    <p className="meta-eyebrow text-[#EAE4D9]/20 mt-3">
