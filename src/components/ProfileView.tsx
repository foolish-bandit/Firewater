            ...
            <div className="flex flex-col md:flex-row gap-6 items-start">
              <div className="relative shrink-0 mx-auto md:mx-0">
                {profile.picture ? (
                  ...
                  <div className="w-24 h-24 sm:w-32 sm:h-32 rounded-full border border-[#EAE4D9]/18 flex items-center justify-center bg-[#C89B3C]/20 text-[#C89B3C] text-4xl sm:text-5xl font-serif shadow-[0_0_0_8px_rgba(200,155,60,0.08)]">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between rounded-full border border-[#EAE4D9]/10 bg-[#EAE4D9]/[0.03] px-4 py-3">
                <div>
                  ...
                  <p className="font-serif text-xl text-[#EAE4D9]">{profile.tried_count}</p>
                </div>
              ...
              <div className="flex items-center justify-between rounded-full border border-[#EAE4D9]/10 bg-[#EAE4D9]/[0.03] px-4 py-3">
                <div>
                  ...
                  <p className="font-serif text-xl text-[#EAE4D9]">{profile.want_count}</p>
                </div>
              ...
              <div className="flex items-center justify-between rounded-full border border-[#EAE4D9]/10 bg-[#EAE4D9]/[0.03] px-4 py-3">
                <div>
                  ...
                  <p className="font-serif text-xl text-[#EAE4D9]">{profile.review_count}</p>
                </div>
              ...
              <div className="grid grid-cols-2 gap-3 pt-2">
                ...
                >
                  ...
                  <p className="mt-2 font-serif text-2xl text-[#EAE4D9]">{profile.follower_count}</p>
                </button>
                <button
                ...
                >
                  ...
                  <p className="mt-2 font-serif text-2xl text-[#EAE4D9]">{profile.following_count}</p>
                </button>
              </div>
              {profile.avg_rating && (
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
                {topShelfLiquors.map((liquor, i) => {
                  ...
                  return (
                    ...
                    >
                      <div className="absolute right-4 top-4 text-[56px] leading-none font-serif text-[#C89B3C] opacity-10">{String(i + 1).padStart(2, '0')}</div>
                      <div className="relative z-10 flex h-full flex-col justify-between gap-6">
                        <div className="space-y-3">
                          ...
                          <div>
                            <h3 className={`font-serif leading-tight text-[#EAE4D9] group-hover:text-[#F3E5BE] transition-colors ${isLead ? 'text-3xl' : 'text-xl'}`}>
                              {liquor.name}
                            </h3>
                        ...
                        <div className="space-y-3">
                          <div className="grid grid-cols-2 gap-3 text-sm">
                            <div className="rounded-[18px] border border-[#EAE4D9]/10 bg-[#EAE4D9]/[0.03] px-3 py-3">
                              ...
                              <p className="mt-1 font-serif text-lg text-[#EAE4D9]">{liquor.proof}</p>
                            </div>
                            <div className="rounded-[18px] border border-[#EAE4D9]/10 bg-[#EAE4D9]/[0.03] px-3 py-3">
                              <p className="text-[10px] tracking-[0.24em] uppercase text-[#EAE4D9]/36">Price</p>
                              <p className="mt-1 font-serif text-lg text-[#EAE4D9]">${liquor.price}</p>
                            </div>
                          </div>
              ...
              <div className="rounded-[28px] border border-[#EAE4D9]/10 bg-[#1A1816] p-5 sm:p-8">
                <div className="flex items-end justify-between gap-4 mb-5">
                  <div>
                    ...
                    <p className="font-serif text-2xl text-[#EAE4D9]">A mapped palate signature</p>
                  </div>
                    ...
                    {leadingNotes.length > 0 ? leadingNotes.map((note, index) => (
                      <div key={note.subject} className="flex items-center justify-between rounded-[20px] border border-[#EAE4D9]/10 bg-[#EAE4D9]/[0.03] px-4 py-3">
                        <div>
                          ...
                          <p className="font-serif text-xl text-[#EAE4D9]">{note.subject}</p>
                        </div>
                        <span className="font-serif text-2xl text-[#C89B3C]">{note.A}</span>
                      </div>
                    )) : (
