...
const PLACEHOLDERS = [
  ...
  'Search by style... "high rye liquor"',
...
export default function HomeView({ user, liquors, wantToTry, tried }: HomeViewProps) {
  ...
  // Community picks: a rotating set of 6 liquors seeded by date
  ...
  // Want-to-try liquors for the user's list preview
  ...
  // Top flavor for a liquor (for the badge)
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="micro-label text-[#C89B3C]">{liquors.length} Bottles on the Shelf</span>
            </div>
          </div>
        </div>
