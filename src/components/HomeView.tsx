          ...
          <div className="relative flex flex-col gap-8">
            ...
            <div className="grid lg:grid-cols-[minmax(0,1.2fr)_minmax(280px,0.8fr)] gap-8 items-start">
              <div>
                ...
                <h1 className="font-display text-4xl md:text-6xl font-normal gold-gradient-text mb-4 leading-tight">
                  Start with a match.
                  <br />
              ...
              <div className="bg-[#141210]/80 border border-[#EAE4D9]/10 p-5 md:p-6 space-y-4">
                <div>
                  ...
                  <h2 className="font-display text-2xl text-[#EAE4D9] mb-2">Know what you want?</h2>
