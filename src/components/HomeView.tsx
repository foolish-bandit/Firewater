    ...
    <div className="flex flex-col min-h-[80vh] animate-in fade-in duration-700">
      ...
      <div className="w-full max-w-5xl mx-auto mb-10">
        <div className="flex items-center justify-between px-4 mb-4">
          <h2 className="font-serif text-xl md:text-2xl text-[#EAE4D9]">Popular discoveries right now</h2>
          <button
            onClick={() => navigate('/catalog')}
        ...
        <div className="w-full max-w-5xl mx-auto mb-10">
          <div className="flex items-center justify-between px-4 mb-4">
            <div className="flex items-center gap-3">
              <h2 className="font-serif text-xl md:text-2xl text-[#EAE4D9]">Your discovery shortlist</h2>
      ...
      <div className="w-full max-w-5xl mx-auto px-4 mb-10">
        <div className="flex items-center justify-between mb-4">
          <h2 className="font-serif text-xl md:text-2xl text-[#EAE4D9]">Browse by starting point</h2>
          <button
            onClick={() => navigate('/catalog')}
            className="text-[#C89B3C] text-xs font-semibold tracking-widest uppercase flex items-center gap-1 hover:gap-2 transition-all"
          >
