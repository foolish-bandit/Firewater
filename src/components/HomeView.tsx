  ...
  return (
    <div className="flex flex-col min-h-[80vh] animate-in fade-in duration-700">
      <div className="w-full max-w-5xl mx-auto px-4 pt-4 md:pt-8 mb-10">
        <div className="bg-[#1A1816] vintage-border p-6 md:p-8 lg:p-10 relative overflow-hidden">
          ...
          <div className="relative flex flex-col gap-8">
            ...
            <div className="grid lg:grid-cols-[minmax(0,1.2fr)_minmax(280px,0.8fr)] gap-8 items-start">
              <div>
                <p className="micro-label text-[#C89B3C] mb-3">Discover your next bottle</p>
              ...
              <div className="bg-[#141210]/80 border border-[#EAE4D9]/10 p-5 md:p-6 space-y-4">
                <div>
                  <p className="micro-label text-[#C89B3C] mb-2">Quick search</p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-left">
                  <div className="border border-[#EAE4D9]/10 bg-[#1A1816]/70 p-3">
                    ...
                    <p className="text-sm text-[#EAE4D9] font-serif">Start with the quiz</p>
                  </div>
                  <div className="border border-[#EAE4D9]/10 bg-[#1A1816]/70 p-3">
                    <p className="micro-label text-[#C89B3C] mb-1">2</p>
                    <p className="text-sm text-[#EAE4D9] font-serif">Refine in the catalog</p>
                  </div>
                  <div className="border border-[#EAE4D9]/10 bg-[#1A1816]/70 p-3">
                    <p className="micro-label text-[#C89B3C] mb-1">3</p>
                    <p className="text-sm text-[#EAE4D9] font-serif">Save the bottles you like</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <p className="text-[#EAE4D9]/50 text-base md:text-lg font-serif italic mb-3">
          The saloon for every spirit. Find bottles, learn what sets them apart, and decide what to try next.
        </p>
        <p className="text-[#EAE4D9]/40 text-sm md:text-base max-w-2xl leading-relaxed mb-8">
          Start with a search, browse what the community is reaching for, or jump into a guided path if you want a faster way to narrow the shelf.
        </p>
      </div>
      ...
      <div className="w-full max-w-5xl mx-auto mb-10">
        <div className="flex items-center justify-between px-4 mb-4">
          <div>
            ...
            <p className="text-sm text-[#EAE4D9]/45 mt-1 max-w-xl leading-relaxed">
              A quick read on bottles getting attention right now, so you can spot popular pours before you open a full review.
            </p>
          </div>
          <button
            onClick={() => navigate('/catalog')}
        ...
        <div className="w-full max-w-3xl mx-auto mb-10">
          <div className="flex items-center justify-between px-4 mb-4 gap-4">
            <div>
              ...
              <p className="text-sm text-[#EAE4D9]/45 mt-1 max-w-xl leading-relaxed">
                Keep your next bottles close at hand so you can compare options, revisit contenders, and know what to hunt for next.
              </p>
            </div>
            <button
      ...
      <div className="w-full max-w-3xl mx-auto px-4 mb-10">
        <div className="flex items-center justify-between mb-4 gap-4">
          <div>
            ...
            <p className="text-sm text-[#EAE4D9]/45 mt-1 max-w-xl leading-relaxed">
              Browse by style, proof, or price when you know the lane you want. Tap a category to head straight into the catalog with that filter applied.
            </p>
          </div>
          <button
            onClick={() => navigate('/catalog')}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          >
            ...
            <div>
              ...
              <p className="text-xs text-[#EAE4D9]/40 font-serif italic leading-relaxed">
                Get a guided recommendation when you want a short list that fits your taste, not the whole shelf.
              </p>
            </div>
          </button>
          ...
          >
            ...
            <div>
              ...
              <p className="text-xs text-[#EAE4D9]/40 font-serif italic leading-relaxed">
                Read plain-spoken reviews to understand why a bottle stands out before you spend the money.
              </p>
            </div>
          </button>
          ...
          >
            ...
            <div>
              ...
              <p className="text-xs text-[#EAE4D9]/40 font-serif italic leading-relaxed">
                Keep your next bottles and finished pours in one place so you always know what to buy or revisit next.
              </p>
            </div>
          </button>
        </div>
