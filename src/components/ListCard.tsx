  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <h4 className="font-display text-lg text-[#EAE4D9] group-hover:text-[#C89B3C] transition-colors truncate">{liquor.name}</h4>
      ...
      <div className="text-right shrink-0">
        <p className="text-sm font-display text-[#EAE4D9]/60">{liquor.proof}°</p>
