    ...
    <>
      <div className="space-y-4">
        <div className="flex items-end justify-between gap-4">
          <div>
            <p className="micro-label text-[#C89B3C]">Visual Notes</p>
            <h3 className="mt-2 font-display text-3xl sm:text-4xl text-[#EAE4D9]">Bottle Identity & Atmosphere</h3>
          </div>
          <div className="hidden sm:flex items-center gap-2 rounded-full border border-[#EAE4D9]/10 bg-[#1A1816]/80 px-4 py-2 backdrop-blur-sm">
            <Images size={14} className="text-[#C89B3C]" />
            <span className="text-[10px] font-sans font-semibold tracking-[0.24em] uppercase text-[#EAE4D9]/60">
        ...
        <div className="space-y-3">
          {primaryPhoto ? (
            ...
            >
              <div className="relative overflow-hidden vintage-border bg-[#141210] aspect-[5/4] sm:aspect-[4/3]">
                ...
                <div className="absolute inset-x-0 bottom-0 p-4 sm:p-5 flex items-end justify-between gap-4">
                  <div>
                    <p className="text-[10px] font-sans font-semibold tracking-[0.24em] uppercase text-[#C89B3C]">Featured Community Photo</p>
                    <p className="mt-1 font-display text-lg sm:text-2xl text-[#EAE4D9] line-clamp-2">{identity.typeLabel}</p>
                  </div>
                  <span className="rounded-full border border-[#EAE4D9]/15 bg-[#141210]/65 px-3 py-1 text-[10px] font-sans font-semibold tracking-[0.22em] uppercase text-[#EAE4D9]/75 backdrop-blur-sm">
                    Tap to expand
                  </span>
                </div>
              </div>
            ...
            <div className="space-y-3">
              ...
              <div
                className="flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-dashed border-[#C89B3C]/20 bg-[#1A1816]/70 px-4 py-3"
                onClick={onUploadClick}
              >
                <div>
                  <p className="text-sm font-serif italic text-[#EAE4D9]/72">No approved photos yet — the hero uses a curated spirit illustration.</p>
                  <p className="mt-1 text-[10px] font-sans font-semibold tracking-[0.22em] uppercase text-[#C89B3C]/70">{identity.mood}</p>
                </div>
                <div className="inline-flex items-center gap-2 text-[10px] font-sans font-semibold tracking-[0.22em] uppercase text-[#C89B3C]">
