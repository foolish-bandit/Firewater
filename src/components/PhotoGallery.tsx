      ...
      <div className="space-y-4">
        <div className="flex items-end justify-between gap-4">
          <div>
            ...
            <h3 className="mt-2 font-serif text-3xl sm:text-4xl text-[#EAE4D9]">Bottle Identity & Atmosphere</h3>
          </div>
              ...
              <div className="relative overflow-hidden vintage-border bg-[#141210] aspect-[5/4] sm:aspect-[4/3]">
                ...
                <div className="absolute inset-x-0 bottom-0 p-4 sm:p-5 flex items-end justify-between gap-4">
                  <div>
                    ...
                    <p className="mt-1 font-serif text-lg sm:text-2xl text-[#EAE4D9] line-clamp-2">{identity.typeLabel}</p>
                  </div>
