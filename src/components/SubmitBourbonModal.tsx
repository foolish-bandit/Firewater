...
export default function SubmitBourbonModal({ onClose, onSubmit, onSelectExisting, existingBourbons, prefillName, prefillDetails, onOpenScanner }: SubmitBourbonModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[var(--color-vintage-bg)]/90 backdrop-blur-sm animate-in fade-in duration-300" role="dialog" aria-modal="true" aria-label="Submit a Bourbon">
