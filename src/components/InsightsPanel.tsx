      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-2 sm:gap-4">
        {[
          ...
          <div key={stat.label} className="bg-[#1A1816] vintage-border p-3 sm:p-5 flex flex-col items-center text-center">
            <span className="font-display text-xl sm:text-2xl text-[#EAE4D9]">{stat.value}</span>
          ...
          {priceStats ? (
            <div className="space-y-5 pt-2">
              <div>
                ...
                <p className="font-display text-3xl text-[#EAE4D9]">${priceStats.avg}</p>
              </div>
              <div>
                <p className="text-[#EAE4D9]/40 text-xs font-sans tracking-wider uppercase mb-1">Price Range</p>
                <p className="font-display text-2xl text-[#EAE4D9]">
            ...
            <div className="space-y-3">
              {topDistilleries.map(([name, count], i) => (
                <div key={name} className="flex items-center gap-3">
                  <span className="flex-shrink-0 w-6 h-6 rounded-full vintage-border flex items-center justify-center text-[#C89B3C] font-display text-xs">
                    {i + 1}
                  </span>
