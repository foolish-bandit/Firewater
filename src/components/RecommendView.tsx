  ...
  return (
    <div className="w-full max-w-xl mx-auto animate-in fade-in slide-in-from-right-4 duration-500">
      ...
      <div className="text-center mb-10">
        ...
        {question.hint && (
          <p className="text-sm font-serif italic text-on-surface-muted mt-3 max-w-md mx-auto">
            {question.hint}
          </p>
        )}
      </div>
  ...
  return (
    <div className="w-full max-w-md mx-auto">
      <div className="text-center mb-4">
        <p className="micro-label text-on-surface-accent mb-2">Your Flavor Profile</p>
        <p className="font-serif text-lg italic text-on-surface">{summary}</p>
      </div>
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-5">
        {highlights.map((flavor, index) => (
          <div key={flavor.key} className="bg-surface-base border border-border-subtle rounded-sm p-3 text-left">
            ...
            <p className="mt-2 text-xs text-on-surface-muted">{flavor.value.toFixed(1)}/10 intensity</p>
          </div>
        ))}
      </div>
      ...
      <p className="micro-label text-on-surface-muted mb-3 text-center">Radar chart for deeper detail</p>
    ...
    return (
      <div className="min-h-[80vh] animate-in fade-in duration-700 space-y-12">
        ...
        <div className="text-center space-y-4 pb-8">
          <p className="text-on-surface-muted font-serif italic">
            Want a different discovery path? Start the discovery quiz.
          </p>
          <button
            onClick={() => {
              handleQuizReset();
            ...
            className="inline-flex items-center gap-2 vintage-border hover:bg-on-surface-accent hover:text-on-surface-invert hover:border-border-accent-strong text-on-surface-accent font-sans font-semibold tracking-widest uppercase px-8 py-3 transition-all duration-300 text-sm"
          >
