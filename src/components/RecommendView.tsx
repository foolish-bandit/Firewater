...
const QUIZ_QUESTIONS: QuizQuestion[] = [
  {
    ...
    hint: 'This sets the foundation — sweet profiles lean toward caramel and vanilla, spicy profiles bring rye heat and leather.',
    answers: [
  ...
  },
  {
    ...
    hint: 'Oak comes from barrel aging. More oak means deeper warmth, tannin, and complexity.',
    answers: [
  ...
  },
  {
    ...
    hint: 'Smoke adds a campfire edge — some love it, some skip it entirely.',
    answers: [
  ...
  },
  {
    ...
    hint: 'This keeps recommendations on your shelf, not just on your wish list.',
    answers: [
  ...
  },
  {
    ...
    hint: 'Higher proof means more heat and intensity — lower proof sips easier and smoother.',
    answers: [
  ...
  return (
    <div className="w-full max-w-xl mx-auto animate-in fade-in slide-in-from-right-4 duration-500">
      ...
      <div className="text-center mb-10">
        ...
        <h2 className="font-display text-3xl md:text-4xl text-[#EAE4D9] leading-tight">
          {question.question}
        </h2>
        {question.hint && (
          <p className="text-sm font-serif italic text-[#EAE4D9]/45 mt-3 max-w-md mx-auto">
            {question.hint}
          </p>
        )}
      </div>
        ...
        {question.answers.map((answer) => (
          ...
          >
            <div className="flex items-center justify-between">
              <span className="font-display text-xl text-[#EAE4D9] group-hover:text-[#C89B3C] transition-colors">
                {answer.label}
              </span>
              <ChevronRight
                size={18}
  ...
  return (
    ...
    >
      ...
      <div className="p-6 flex-1 flex flex-col">
        <h3 className="font-display text-2xl font-normal text-[#EAE4D9] group-hover:text-[#C89B3C] transition-colors leading-tight mb-2 pr-24">
          {liquor.name}
        </h3>
  ...
  return (
    <div className="w-full max-w-md mx-auto">
      <div className="text-center mb-4">
        ...
        <p className="font-serif text-lg italic text-[#EAE4D9]">{summary}</p>
      </div>
  ...
  return (
    <div className="animate-in fade-in duration-700 space-y-12">
      ...
      <div className="text-center space-y-3">
        ...
        <h1 className="font-display text-4xl md:text-5xl text-[#EAE4D9]">{title}</h1>
      ...
      <div>
        <div className="text-center mb-8">
          <p className="micro-label text-[#C89B3C] mb-2">Your Matches</p>
          <h2 className="font-display text-3xl text-[#EAE4D9]">Bottles Matched to Your Palate</h2>
          <p className="text-sm font-serif italic text-[#EAE4D9]/50 max-w-lg mx-auto mt-2">
            Each match is ranked by how closely its flavor profile aligns with yours. Tap any bottle to explore its full story, or heart it to save it to your shelf.
          </p>
        </div>
        ...
        {recommendations.length === 0 && (
          <div className="text-center py-16">
            <p className="text-[#EAE4D9]/40 font-serif italic text-lg">
              No bottles matched that exact combination. Try retaking the quiz with a wider price range or different proof preference — or browse the full catalog to explore on your own terms.
            </p>
          </div>
        )}
      </div>
    ...
    return (
      <div className="min-h-[80vh] animate-in fade-in duration-700 space-y-12">
        <ResultsView
          ...
          subtitle="Bottles chosen from your tasting history — the more you try and rate, the sharper these picks become"
        />
        ...
        <div className="text-center space-y-4 pb-8">
          <p className="text-[#EAE4D9]/50 font-serif italic">
            Looking for something outside your usual lane? The discovery quiz matches you based on what you tell us, not just what you've tried before.
          </p>
          <button
            onClick={() => {
              handleQuizReset();
    ...
    return (
      <div className="min-h-[80vh]">
        <ResultsView
          ...
          title="Your Quiz Matches"
          subtitle="Ranked by how closely each bottle's profile aligns with the preferences you just told us"
        />
      </div>
    );
  }
    ...
    <div className="min-h-[80vh] flex flex-col items-center pt-8 md:pt-16 animate-in fade-in duration-700">
      ...
      {quizStep === 0 && (
        <div className="text-center space-y-4 mb-12">
          ...
          <h1 className="font-display text-4xl md:text-5xl text-[#EAE4D9]">Discovery Quiz</h1>
          <p className="text-[#EAE4D9]/60 font-serif italic text-lg max-w-md mx-auto">
            Tell us what you like in five quick taps — sweet or spicy, oaky or smooth, budget or splurge. We'll match you to bottles that fit your palate and show you why each one made the cut.
          </p>
        </div>
      )}
