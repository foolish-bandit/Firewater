  ...
  return (
    <div className="w-full max-w-xl mx-auto animate-in fade-in slide-in-from-right-4 duration-500">
      ...
      <div className="text-center mb-10">
        ...
        <p className="text-[#EAE4D9]/45 max-w-lg mx-auto mt-3 leading-relaxed">
          Pick the answer that sounds closest to your taste. We use these five choices to narrow the shelf to bottles worth opening next.
        </p>
      </div>
  ...
  return (
    <div className="animate-in fade-in duration-700 space-y-12">
      ...
      <div className="text-center space-y-3">
        ...
        <p className="text-[#EAE4D9]/45 max-w-2xl mx-auto leading-relaxed">
          This list is here to shorten the decision. Start with the highest-match bottles, open a detail page, and save any contenders to your list before you buy.
        </p>
      </div>
      ...
      <div>
        <div className="text-center mb-8">
          ...
          <p className="text-[#EAE4D9]/45 max-w-2xl mx-auto mt-2 leading-relaxed">
            Compare these picks first. Each match combines your flavor leanings with price and proof preferences where possible.
          </p>
        </div>
        ...
        {recommendations.length === 0 && (
          <div className="text-center py-16">
            <h3 className="font-serif text-xl text-[#EAE4D9] mb-2">No close matches yet</h3>
            <p className="text-[#EAE4D9]/40 font-serif italic text-lg mb-2">
              Those answers narrowed the shelf too much for a confident recommendation.
            </p>
            <p className="text-[#EAE4D9]/45 max-w-lg mx-auto leading-relaxed">
              Retake the quiz with broader price or proof preferences to surface more bottles worth considering.
            </p>
          </div>
        )}
      </div>
    ...
    return (
      <div className="min-h-[80vh] animate-in fade-in duration-700 space-y-12">
        <ResultsView
          ...
          subtitle="Based on the bottles you have already marked as tried"
        />
        ...
        <div className="text-center space-y-4 pb-8">
          ...
          <p className="text-[#EAE4D9]/45 max-w-xl mx-auto leading-relaxed">
            Use it when your history does not tell the whole story yet, or when you want recommendations for a specific mood instead of your usual palate.
          </p>
          <button
            onClick={() => {
              handleQuizReset();
    ...
    return (
      <div className="min-h-[80vh]">
        <ResultsView
          ...
          title="Your Matches"
          subtitle="Based on the flavor, proof, and price signals you picked in the quiz"
        />
      </div>
    );
  }
    ...
    <div className="min-h-[80vh] flex flex-col items-center pt-8 md:pt-16 animate-in fade-in duration-700">
      ...
      {quizStep === 0 && (
        <div className="text-center space-y-4 mb-12">
          ...
          <h1 className="font-serif text-4xl md:text-5xl text-[#EAE4D9]">Discovery Quiz</h1>
          ...
          <p className="text-[#EAE4D9]/45 max-w-2xl mx-auto leading-relaxed">
            This is the fast lane for new users or anyone browsing without a strong shortlist. Pick what sounds good, then review the top matches and save the bottles you want to chase down.
          </p>
        </div>
      )}
