...
export default function NotFoundPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4 animate-in fade-in duration-500">
      <div className="font-serif text-[120px] md:text-[180px] leading-none text-[#C89B3C]/10 select-none mb-[-2rem]">
        404
      </div>
      <h1 className="font-serif text-3xl md:text-4xl text-[#EAE4D9] mb-3">
        Trail Gone Cold
      </h1>
