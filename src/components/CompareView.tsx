    ...
    <div className="experience-page animate-in fade-in duration-500">
      ...
      <section className="experience-hero">
        <div className="text-center sm:text-left space-y-3">
          <p className="section-kicker">Analyze side by side</p>
          <h1 className="font-serif text-4xl sm:text-5xl font-normal text-[#EAE4D9]">Compare Liquors</h1>
          <p className="section-copy max-w-2xl">
            Pick two or three pours to line up their flavor arcs, specs, and biggest points of contrast.
          </p>
        </div>

      {/* Selection Area */}
      <div className="bg-[#141210]/60 vintage-border p-5 sm:p-8 space-y-4">
      ...
      {selectedLiquors.length < 2 && (
        <div className="experience-meta-card inset text-center py-16">
      ...
      {selectedLiquors.length >= 2 && (
        <div className="experience-support">
          ...
          <div className="experience-support-block bg-[#1A1816] vintage-border p-5 sm:p-8">
            <h3 className="section-kicker mb-2">Flavor profile overlay</h3>
          ...
          <div className="bg-[#1A1816] vintage-border p-5 sm:p-8">
            <div className="flex flex-col gap-6">
              ...
              <div className="border-t border-[#EAE4D9]/10 pt-6">
                <p className="micro-label text-[#EAE4D9]/35 mb-3">Radar chart for full-shape comparison</p>
          ...
          <div className="experience-meta-card inset">
            <h3 className="section-kicker mb-4 sm:mb-6">Specifications</h3>
              ...
              <table className="w-full text-sm font-sans">
                <thead>
                  <tr className="border-b border-[#EAE4D9]/10">
                    <th className="text-left py-3 pr-4 text-[#EAE4D9]/40 font-semibold tracking-[0.12em] uppercase text-xs">Attribute</th>
                    {selectedLiquors.map((b, i) => (
                ...
                <tbody>
                  {[
                    ...
                    <tr key={row.label} className="border-b border-[#EAE4D9]/5">
                      <td className="py-3 pr-4 text-[#EAE4D9]/40 font-semibold tracking-[0.12em] uppercase text-xs">{row.label}</td>
            ...
            <div className="md:hidden space-y-4">
              {[
                ...
                <div key={row.label} className="border-b border-[#EAE4D9]/5 pb-3">
                  <p className="text-[#EAE4D9]/40 font-semibold tracking-[0.12em] uppercase text-[10px] mb-2">{row.label}</p>
          ...
          {flavorDiffs.length > 0 && (
            <div className="experience-meta-card inset">
              <h3 className="section-kicker mb-4 sm:mb-6">Biggest flavor differences</h3>
              <div className="space-y-4">
                {flavorDiffs.slice(0, 6).map((d) => (
                  <div key={d.key} className="space-y-2">
                    <div className="flex items-center justify-between">
                      <span className="text-xs font-sans font-semibold tracking-[0.12em] uppercase text-[#EAE4D9]/60">{d.label}</span>
