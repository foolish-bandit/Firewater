  ...
  return (
    <div className="space-y-10 animate-in fade-in duration-500">
      <div className="text-center space-y-4 py-8">
        <p className="micro-label text-[#C89B3C]">Collection Journey</p>
        <h1 className="font-display text-4xl md:text-5xl font-normal text-[#EAE4D9]">My Shelf</h1>
        <p className="text-[#EAE4D9]/60 font-serif italic max-w-2xl mx-auto text-lg">Your personal tasting journal. Track every bottle that catches your eye, log the ones you've tasted, and watch your palate story take shape over time.</p>
        <p className="text-sm font-serif italic text-[#EAE4D9]/45 max-w-xl mx-auto mt-2">
          Two lists, one shelf. "Want to try" holds bottles you're eyeing. "Tried &amp; tasted" holds the ones you've claimed. Together they tell the story of your whiskey journey.
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-[minmax(0,1.2fr)_minmax(320px,0.8fr)] gap-5">
          <div className="rounded-[30px] border border-[#C89B3C]/18 bg-[radial-gradient(circle_at_top_left,rgba(200,155,60,0.18),transparent_36%),linear-gradient(145deg,#1B1713_0%,#141210_100%)] p-5 sm:p-7">
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-5 mb-5">
              <div>
                <p className="micro-label text-[#C89B3C] mb-2">Progress Story</p>
                <h2 className="font-display text-3xl text-[#EAE4D9]">Your collection arc</h2>
              </div>
          ...
          <div className="rounded-[30px] border border-[#EAE4D9]/10 bg-[#1A1816] p-5 sm:p-6">
            <div className="flex items-center gap-2 mb-5">
              ...
              <p className="micro-label text-[#C89B3C]">Milestones & Categories</p>
            </div>
