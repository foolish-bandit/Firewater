    ...
    <div className="space-y-10 animate-in fade-in duration-500">
      ...
      <div className="text-center space-y-4 py-8">
        ...
        <p className="text-[#EAE4D9]/45 max-w-2xl mx-auto leading-relaxed">
          Use this space to track what you plan to buy, what you have already tasted, and how far along you are in building your personal lineup.
        </p>
      </div>
          ...
          {wantLiquors.length === 0 ? (
            <div className="bg-[#1A1816] vintage-border border-dashed p-8 sm:p-16 text-center relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <h3 className="font-serif text-xl text-[#EAE4D9] mb-2">Build your hit list</h3>
                <p className="text-[#EAE4D9]/40 font-serif italic text-lg mb-2">Your want-to-try list keeps bottles you are curious about in one place.</p>
                <p className="text-[#EAE4D9]/45 max-w-md mx-auto mb-6 leading-relaxed">Browse the catalog, then tap the heart on any bottle you want to compare, remember, or come back to later.</p>
                <button
          ...
          {triedLiquors.length === 0 ? (
            <div className="bg-[#1A1816] vintage-border border-dashed p-8 sm:p-16 text-center relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <h3 className="font-serif text-xl text-[#EAE4D9] mb-2">Start your tasting trail</h3>
                <p className="text-[#EAE4D9]/40 font-serif italic text-lg mb-2">Your tried list becomes your tasting history inside FIREWATER.</p>
                <p className="text-[#EAE4D9]/45 max-w-md mx-auto mb-6 leading-relaxed">Mark bottles as tried after you taste them so your recommendations and insights have something real to work from.</p>
                <button
                  onClick={() => navigate('/catalog')}
                  className="bg-transparent vintage-border hover:bg-[#C89B3C] hover:text-[#141210] hover:border-[#C89B3C] text-[#C89B3C] font-sans font-semibold tracking-widest uppercase px-6 py-3 text-xs transition-all duration-300"
                >
                  Mark Your First Pour
                </button>
              </div>
            </div>
          ) : (
