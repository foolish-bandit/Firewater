            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-3">
                {journeyCards.map((card) => {
                  ...
                  return (
                    <div key={card.title} className="rounded-[22px] border border-border-subtle bg-[#EAE4D9]/[0.03] p-4">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                {categoryJourney.completionByCategory.length > 0 ? categoryJourney.completionByCategory.map((category) => (
                  <div key={category.type} className="rounded-[20px] border border-border-subtle bg-[#EAE4D9]/[0.03] p-4">
