                        ...
                        <div className="space-y-2">
                          <p className="text-sm sm:text-[15px] text-[#EAE4D9]/88 leading-relaxed">
                            ...
                            <button
                              ...
                              className={`font-serif text-lg leading-none transition-colors ${style.highlight}`}
                            >
                              {liquorName}
                            </button>
                          </p>
                            ...
                            <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
                              <div className="inline-flex items-center gap-2 text-[#EAE4D9]/75">
                                ...
                                <div>
                                  ...
                                  <p className="font-serif text-base text-[#EAE4D9] leading-tight">{liquor?.distillery || 'Community bottle'}</p>
                                </div>
                              </div>
