      ...
      <div className="bg-[#1A1816] vintage-border p-6 md:p-8 max-w-md w-full shadow-2xl relative max-h-[90vh] overflow-y-auto">
        ...
        {method !== 'google' && (
          <form onSubmit={handleSubmit} className="space-y-4">
            {mode === 'signup' && (
              <div>
                <label className="block text-xs font-semibold tracking-widest uppercase text-[#EAE4D9]/60 mb-1.5">
                  Name
                </label>
                <input
                  type="text"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-transparent vintage-border hover:bg-[#C89B3C] hover:text-[#141210] hover:border-[#C89B3C] text-[#C89B3C] font-semibold tracking-widest uppercase py-3 transition-all duration-300 text-sm disabled:opacity-50"
            >
