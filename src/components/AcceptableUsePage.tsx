  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8 md:py-12">
      ...
      <div className="mt-8 mb-10">
        ...
        <h1 className="font-display text-3xl md:text-4xl font-normal text-[#EAE4D9] mb-3">Acceptable Use Policy</h1>
      ...
      <div className="space-y-10 text-[#EAE4D9]/70 font-serif italic leading-relaxed">
        ...
        <section>
          <h2 className="font-display not-italic text-xl text-[#EAE4D9] mb-4">1. Permitted Use</h2>
          <p className="mb-4">
        ...
        <section>
          <h2 className="font-display not-italic text-xl text-[#EAE4D9] mb-4">2. Prohibited Activities</h2>
          <p className="mb-4">
        ...
        <section>
          <h2 className="font-display not-italic text-xl text-[#EAE4D9] mb-4">3. Content Standards</h2>
          <p className="mb-4">
        ...
        <section>
          <h2 className="font-display not-italic text-xl text-[#EAE4D9] mb-4">4. Enforcement</h2>
          <p className="mb-4">
        ...
        <section>
          <h2 className="font-display not-italic text-xl text-[#EAE4D9] mb-4">5. Reporting</h2>
          <p>
        ...
        <section>
          <h2 className="font-display not-italic text-xl text-[#EAE4D9] mb-4">6. Changes to This Policy</h2>
          <p>
        ...
        <section>
          <h2 className="font-display not-italic text-xl text-[#EAE4D9] mb-4">7. Contact</h2>
          <p>
