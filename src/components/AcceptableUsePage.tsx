  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8 md:py-12">
      ...
      <div className="space-y-10 text-[#EAE4D9]/70 font-serif italic leading-relaxed">
        <section>
          <p>
            This Acceptable Use Policy sets forth the rules and guidelines for using FIREWATER. By accessing or using our
            platform, you agree to comply with this policy. FIREWATER reserves the right to take appropriate action
        ...
        <section>
          ...
          <p className="mb-4">
            FIREWATER is designed to be a community platform for bourbon enthusiasts. You are encouraged to:
          </p>
        ...
        <section>
          ...
          <ul className="list-disc list-inside space-y-2 ml-4">
            ...
            <li>Content must be relevant to bourbon, whiskey, and the FIREWATER community</li>
