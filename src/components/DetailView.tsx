...
export default function DetailView({ wantToTry, tried, toggleWantToTry, toggleTried, getReviewsForLiquor, onAddReview, onEditReview, onDeleteReview, user, liquors }: DetailViewProps) {
  ...
  return (
    <div className="experience-page animate-in slide-in-from-right-8 duration-500">
      <button
        onClick={() => navigate(-1)}
      ...
      {/* Hero Header */}
      <section className="experience-hero relative">
        {/* Proof watermark */}
        ...
        <div className="relative z-10 space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 sm:gap-6">
            <div className="flex flex-col gap-2">
              {liquor.source === 'community' && (
                <span className="self-start px-2 py-1 bg-[#C89B3C]/20 text-[10px] font-sans font-semibold tracking-[0.12em] uppercase text-[#C89B3C] border border-[#C89B3C]/30 rounded-sm">
          ...
          <div className="grid grid-cols-4 gap-2 sm:gap-4 max-w-lg">
            ...
            <button
              ...
              className={`flex items-center justify-center gap-2 sm:gap-3 py-3 sm:py-4 vintage-border transition-all duration-300 font-sans font-semibold tracking-[0.12em] uppercase text-[10px] sm:text-xs ${isTried ? 'bg-[#C89B3C]/10 border-[#C89B3C]/50 text-[#C89B3C]' : 'bg-transparent text-[#EAE4D9]/60 hover:text-[#C89B3C] hover:border-[#C89B3C]/30'}`}
            >
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 sm:gap-3 py-3 sm:py-4 vintage-border transition-all duration-300 font-sans font-semibold tracking-[0.12em] uppercase text-[10px] sm:text-xs bg-transparent text-[#EAE4D9]/60 hover:text-[#C89B3C] hover:border-[#C89B3C]/30"
            >
      ...
      <section className="experience-meta">
        <div className="experience-meta-card inset">
            ...
            <div className="space-y-6">
              <div className="space-y-3">
                ...
                <div className="flex flex-wrap gap-2">
                  <span className="px-3 py-1 bg-[#1A1816] vintage-border text-[10px] font-sans font-semibold tracking-[0.22em] uppercase text-[#C89B3C]">
                    {liquor.type}
                  </span>
                  <span className="px-3 py-1 border border-[#EAE4D9]/15 rounded-full text-[10px] font-sans font-semibold tracking-[0.22em] uppercase text-[#EAE4D9]/55">
                    {liquor.region}
                  </span>
                  <span className="px-3 py-1 border border-[#EAE4D9]/15 rounded-full text-[10px] font-sans font-semibold tracking-[0.22em] uppercase text-[#EAE4D9]/55">
                    {liquor.age}
              ...
              <p className="text-[#EAE4D9]/72 text-lg leading-relaxed font-serif italic">{liquor.description}</p>

              <div>
                <p className="micro-label text-[#C89B3C] mb-3">Primary tasting notes</p>
                <div className="flex flex-wrap gap-2">
                  {topFlavors.map(flavor => (
                    <span key={flavor} className="px-3 py-1 text-[10px] font-sans font-semibold tracking-[0.22em] uppercase text-[#EAE4D9]/70 border border-[#EAE4D9]/15 rounded-full bg-[#1A1816]/60">
                      {flavor}
                    </span>
                  ))}
                </div>
      ...
      {/* Stats */}
      <section className="experience-meta">
        <div className="experience-meta-grid grid-cols-2 md:grid-cols-4 gap-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-[#1A1816] vintage-border p-5 sm:p-8">
          <h3 className="section-kicker mb-3">Mash bill</h3>
        ...
        {/* Dominant Flavors */}
        <div className="bg-[#1A1816] vintage-border p-5 sm:p-8">
          <h3 className="section-kicker mb-3">Dominant notes</h3>
      ...
      <div className="bg-[#1A1816] vintage-border p-5 sm:p-8">
        <h3 className="section-kicker mb-4 sm:mb-8">Flavor profile</h3>
      ...
      {/* Reviews Section */}
      <section className="experience-meta">
      <div className="space-y-10 experience-meta-card">
        <div className="flex items-center justify-between">
          <div>
            <p className="section-kicker mb-2">Thoughts</p>
          ...
          {avgRating && (
            <div className="text-right">
              ...
              <p className="meta-eyebrow text-[#EAE4D9]/40">{avgRating} avg · {reviews.length} review{reviews.length !== 1 ? 's' : ''}</p>
            </div>
          )}
        </div>
