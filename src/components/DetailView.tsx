  ...
  return (
    <div className="flex flex-col animate-in slide-in-from-right-8 duration-500">
      ...
      <div className="relative mb-hero">
        {/* Proof watermark */}
        <div className="absolute -top-4 right-0 font-display text-[80px] sm:text-[120px] md:text-[180px] leading-none text-[#EAE4D9] opacity-[0.03] select-none pointer-events-none overflow-hidden">
          {liquor.proof}
        </div>
        ...
        <div className="relative z-10 space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 sm:gap-6">
            <div className="flex flex-col gap-2">
              ...
              <h1 className="font-display text-4xl sm:text-5xl md:text-6xl font-normal text-[#EAE4D9] leading-none">{liquor.name}</h1>
            </div>
            {avgRating && (
          ...
          <div className="grid grid-cols-1 xl:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)] gap-8 xl:gap-10 items-start">
            ...
            <div className="space-y-6">
              <div className="space-y-3">
                <p className="text-xs text-[#C89B3C] font-sans font-semibold tracking-wider uppercase">{liquor.distillery}</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-subsection">
        {/* Mash Bill */}
        <div className="border-l-2 border-l-[#C89B3C]/30 pl-5 py-1">
          <h3 className="font-serif text-lg text-[#EAE4D9]/70 mb-3">Mash Bill</h3>
        ...
        {/* Dominant Flavors */}
        <div className="border-l-2 border-l-[#C89B3C]/30 pl-5 py-1">
          <h3 className="font-serif text-lg text-[#EAE4D9]/70 mb-3">Dominant Notes</h3>
      ...
      <div className="bg-[#1A1816] vintage-border p-4 sm:p-6 mt-section">
        <div className="flex flex-col gap-5 md:flex-row md:items-start md:justify-between">
          <div className="max-w-2xl">
            <h3 className="font-serif text-2xl text-[#EAE4D9] mb-3">Flavor Profile</h3>
      ...
      {/* Similar Liquors */}
      <div className="space-y-8 mt-section">
        <h2 className="font-serif text-2xl font-normal text-[#EAE4D9]">Similar Taste Profiles</h2>
      ...
      <div className="space-y-10 mt-subsection">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="font-serif text-2xl font-normal text-[#EAE4D9]">Reviews</h2>
          </div>
          {avgRating && (
        ...
        <div className="bg-[#C89B3C]/5 vintage-border p-5 sm:p-8">
          <h3 className="font-display text-2xl text-[#EAE4D9] mb-4 sm:mb-6">Leave a Review</h3>
        ...
        <div className="space-y-6">
          {reviews.length === 0 ? (
            ...
            reviews.map((review: Review) => (
              <div key={review.id} className="border-b border-[#EAE4D9]/10 pb-6 last:border-0 space-y-4">
                {editingId === review.id ? (
