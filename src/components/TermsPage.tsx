  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8 md:py-12">
      ...
      <div className="space-y-10 text-[#EAE4D9]/70 font-serif italic leading-relaxed">
        ...
        <section>
          <h2 className="font-serif not-italic text-xl text-[#EAE4D9] mb-4">5. AI-Powered Features</h2>
          <p className="mb-4">
        ...
        <section>
          <h2 className="font-serif not-italic text-xl text-[#EAE4D9] mb-4">6. Disclaimer</h2>
          <p>
        ...
        <section>
          <h2 className="font-serif not-italic text-xl text-[#EAE4D9] mb-4">7. Limitations</h2>
          <p>
        ...
        <section>
          <h2 className="font-serif not-italic text-xl text-[#EAE4D9] mb-4">8. Governing Law</h2>
          <p>
