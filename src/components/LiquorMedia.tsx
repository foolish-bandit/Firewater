      ...
      {imageUrl ? (
        ...
        <>
          ...
          <div className="absolute right-4 top-4 text-right">
            <p className="text-[11px] font-sans font-semibold tracking-[0.24em] uppercase text-on-surface-muted">{identity.family}</p>
            <p className="mt-1 max-w-[12rem] text-[11px] font-serif italic leading-relaxed text-on-surface-muted">{identity.mood}</p>
          </div>
            ...
            <div className="absolute inset-x-4 bottom-4 rounded-2xl border border-border-subtle bg-surface-base/58 p-4 backdrop-blur-md">
              <div className="flex items-start justify-between gap-3">
                <div>
                  ...
                  <p className="mt-1 font-display text-lg leading-tight text-on-surface line-clamp-2">{identity.typeLabel}</p>
                </div>
                <div className="rounded-full border border-border-subtle bg-white/5 p-2 text-on-surface-secondary">
                  <GlassWater size={16} />
                </div>
              </div>
              <div className="mt-3 flex items-center justify-between gap-3 text-[10px] font-sans font-semibold tracking-[0.22em] uppercase">
                <span className="text-on-surface-muted">{identity.family}</span>
                <span className="inline-flex items-center gap-1.5 text-on-surface-accent/80">
