  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8 md:py-12">
      ...
      <div className="space-y-10 text-[#EAE4D9]/70 font-serif italic leading-relaxed">
        ...
        <section>
          <h2 className="font-serif not-italic text-xl text-[#EAE4D9] mb-4">6. Local Storage, Cookies, and Tracking</h2>
          <p className="mb-4">
        ...
        <section>
          <h2 className="font-serif not-italic text-xl text-[#EAE4D9] mb-4">8. Age Requirement &amp; Children's Privacy</h2>
          <p className="mb-4">
        ...
        <section>
          <h2 className="font-serif not-italic text-xl text-[#EAE4D9] mb-4">9. Changes to This Policy</h2>
          <p>
        ...
        <section>
          <h2 className="font-serif not-italic text-xl text-[#EAE4D9] mb-4">10. Contact</h2>
          <p>
