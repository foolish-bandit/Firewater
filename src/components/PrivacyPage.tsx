  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8 md:py-12">
      ...
      <div className="space-y-10 text-on-surface-secondary font-serif italic leading-relaxed">
        <section>
          <h2 className="font-display not-italic text-xl text-on-surface mb-4">1. Information Collection</h2>
          <p className="mb-4">
        ...
        <section>
          <h2 className="font-display not-italic text-xl text-on-surface mb-4">2. Use of Information</h2>
          <p className="mb-4">
        ...
        <section>
          <h2 className="font-display not-italic text-xl text-on-surface mb-4">3. Data Security</h2>
          <p>
        ...
        <section>
          <h2 className="font-display not-italic text-xl text-on-surface mb-4">4. Data Retention</h2>
          <p>
        ...
        <section>
          <h2 className="font-display not-italic text-xl text-on-surface mb-4">5. Third-Party Services</h2>
          <p className="mb-4">
        ...
        <section>
          <h2 className="font-display not-italic text-xl text-on-surface mb-4">6. Local Storage, Cookies, and Tracking</h2>
          <p className="mb-4">
        ...
        <section>
          <h2 className="font-display not-italic text-xl text-on-surface mb-4">7. Your Rights</h2>
          <p className="mb-4">
        ...
        <section>
          <h2 className="font-display not-italic text-xl text-on-surface mb-4">8. Age Requirement &amp; Children's Privacy</h2>
          <p className="mb-4">
        ...
        <section>
          <h2 className="font-display not-italic text-xl text-on-surface mb-4">9. Changes to This Policy</h2>
          <p>
        ...
        <section>
          <h2 className="font-display not-italic text-xl text-on-surface mb-4">10. Contact</h2>
          <p>
