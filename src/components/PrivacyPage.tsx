    ...
    <div className="max-w-3xl mx-auto px-4 py-8 md:py-12">
      ...
      <div className="space-y-10 text-[#EAE4D9]/70 font-serif italic leading-relaxed">
        <section>
          ...
          <p className="mb-4">
            BRRL Book collects information you provide directly to us when you create an account, submit reviews, or
          ...
          <ul className="list-disc list-inside space-y-2 ml-4">
            ...
            <li>Bourbon collections and wish lists</li>
            <li>Usage data and browsing activity within the platform</li>
          </ul>
          <p className="mt-4">
            We may also automatically collect certain information when you use BRRL Book, including your IP address,
        ...
        <section>
          ...
          <ul className="list-disc list-inside space-y-2 ml-4">
            <li>Provide, maintain, and improve BRRL Book</li>
        ...
        <section>
          ...
          <p>
            BRRL Book may contain links to third-party websites or services that are not owned or controlled by us. We
        ...
        <section>
          ...
          <p>
            BRRL Book uses cookies and similar tracking technologies to track activity on our platform and hold certain
        ...
        <section>
          ...
          <p className="mt-4">
            To exercise any of these rights, please contact us through the BRRL Book platform.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            If you have any questions about this Privacy Policy, please contact us through the BRRL Book platform.
          </p>
        </section>
      </div>
    </div>
