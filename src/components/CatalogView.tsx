        ...
        {paginatedLiquors.length > 0 ? (
          ...
          <div className="col-span-full text-center py-20 space-y-6">
            ...
            <div>
              ...
              <p className="text-on-surface-muted max-w-md mx-auto mb-6">Try broadening your filters, changing your search words, or starting with the discovery quiz for a fresh path.</p>
