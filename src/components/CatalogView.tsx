  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      <div className="bg-[#1A1816] vintage-border p-4 sm:p-6 space-y-6">
        <div className="flex flex-col xl:flex-row gap-6 xl:items-end xl:justify-between">
          <div className="space-y-3 max-w-2xl">
            <div className="flex items-baseline gap-3 flex-wrap">
              ...
              <span className="text-xs text-[#C89B3C] font-sans font-semibold tracking-wider">{sortedLiquors.length} bottles</span>
            </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full xl:w-auto">
            <button
              ...
              className="inline-flex items-center justify-center gap-2 bg-[#C89B3C] text-[#141210] px-5 py-3 font-sans font-semibold tracking-widest uppercase hover:bg-[#D4A843] transition-all duration-300"
            >
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 vintage-border hover:bg-[#C89B3C] hover:text-[#141210] hover:border-[#C89B3C] text-[#C89B3C] px-5 py-3 font-sans font-semibold tracking-widest uppercase transition-all duration-300"
            >
        ...
        <div className="grid grid-cols-1 xl:grid-cols-[minmax(0,1.4fr)_minmax(280px,0.6fr)] gap-4">
          <form onSubmit={handleSearch} className="relative">
            ...
            <input
              ...
              placeholder='Try "smooth and sweet," "Buffalo Trace," "under 50," or "barrel proof"...'
              className="w-full bg-[#141210] border border-[#EAE4D9]/20 py-3 pl-10 pr-24 text-[#EAE4D9] placeholder-[#EAE4D9]/40 focus:outline-none focus:border-[#C89B3C] transition-all font-serif italic text-sm rounded-sm"
            />
          ...
          <div className="flex items-center gap-2 justify-between xl:justify-end">
            <span className="text-xs text-[#EAE4D9]/40 font-sans">Sort</span>
            <select
              value={sortBy}
        ...
        <div className="flex gap-2 overflow-x-auto pb-1 -mx-1 px-1 sm:flex-wrap sm:overflow-visible">
          {categories.map(cat => (
            <button
              ...
              className={`px-3 sm:px-4 py-2 text-[10px] sm:text-xs font-semibold tracking-wider sm:tracking-widest uppercase transition-all border whitespace-nowrap shrink-0 sm:shrink ${
                activeCategory === cat
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 border-t border-[#EAE4D9]/10 pt-4">
          <div className="col-span-full mb-1">
            <p className="micro-label text-[#C89B3C] mb-1">Narrow the shelf</p>
            <p className="text-sm font-serif italic text-[#EAE4D9]/50">Slide to set your price ceiling and proof floor — only matching bottles will show.</p>
          </div>
        ...
        <div className="border-t border-[#EAE4D9]/10 pt-4 flex flex-col lg:flex-row gap-4 lg:items-center lg:justify-between">
          <div>
            <p className="text-sm text-[#EAE4D9]/75 leading-relaxed">
          ...
          <div className="flex flex-wrap gap-2">
            {filterDescriptions.map((description) => (
              <span
                key={description}
                className="px-3 py-1.5 text-[10px] font-semibold tracking-widest uppercase bg-[#C89B3C]/10 text-[#EAE4D9]/80 border border-[#C89B3C]/20 rounded-full"
              >
                {description}
              </span>
            ))}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {paginatedLiquors.length > 0 ? (
          ...
          <div className="col-span-full text-center py-20 space-y-6">
            ...
            <div>
              <h3 className="text-xl font-display text-[#EAE4D9] mb-2">Nothing on the shelf matches those filters</h3>
              <p className="text-[#EAE4D9]/60 max-w-md mx-auto mb-6">Widen your price or proof range, try different search terms, or clear all filters to see the full catalog. You can also take the discovery quiz for a guided starting point, or submit a bottle if you know one we're missing.</p>
      ...
      {totalPages > 1 && (
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-8">
          <span className="text-xs text-[#C89B3C]/70 font-sans">
          ...
          <div className="flex items-center gap-4">
            <button
              ...
              disabled={page === 1}
              className="px-4 py-1.5 text-xs font-semibold tracking-widest uppercase transition-colors border border-[#EAE4D9]/10 text-[#C89B3C] hover:bg-[#C89B3C] hover:text-[#141210] hover:border-[#C89B3C] disabled:opacity-30 disabled:pointer-events-none"
            >
              Previous
            </button>
