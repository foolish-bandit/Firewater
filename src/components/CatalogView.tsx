      ...
      <div className="bg-[#1A1816] vintage-border p-4 sm:p-6 space-y-4 sm:space-y-6">
        <div className="flex flex-col md:flex-row gap-6 items-start md:items-center justify-between">
           <div className="space-y-2">
             ...
             <p className="text-sm text-[#EAE4D9]/45 max-w-2xl leading-relaxed">
               Search, scan, or filter the full shelf to compare bottles. Start broad, then narrow by flavor, price, proof, or style when you are ready to choose a bottle.
             </p>
           </div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-[minmax(0,1.4fr)_minmax(280px,0.6fr)] gap-4">
          <form onSubmit={handleSearch} className="relative">
            ...
            <input
              ...
              placeholder="Search by bottle, distillery, flavor, or price"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {paginatedLiquors.length > 0 ? (
              ...
              <div className="col-span-full text-center py-20 space-y-6">
                ...
                <div>
                  <h3 className="text-xl font-serif text-[#EAE4D9] mb-2">No bottles on this trail</h3>
                  <p className="text-[#EAE4D9]/60 max-w-md mx-auto mb-2">Your current search and filters did not return any matches.</p>
                  <p className="text-[#EAE4D9]/45 max-w-lg mx-auto mb-6 leading-relaxed">Clear a few filters to widen the list, or add a missing bottle if FIREWATER does not have it yet.</p>
                  <div className="flex flex-wrap items-center justify-center gap-4">
                    ...
                    >
                      <Plus size={16} /> Add Missing Bottle
                    </button>
                    <button
