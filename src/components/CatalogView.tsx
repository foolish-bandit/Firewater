  ...
  return (
    <div className="experience-page animate-in fade-in duration-500">
      ...
      <section className="experience-hero">
        <div className="flex flex-col md:flex-row gap-6 items-start md:items-center justify-between">
           <div className="flex items-baseline gap-3">
             <h2 className="font-serif text-3xl sm:text-4xl text-[#EAE4D9]">The Catalog</h2>
             <span className="section-kicker">{sortedLiquors.length} liquors</span>
           </div>
        ...
        <div className="flex gap-2 overflow-x-auto pb-1 -mx-1 px-1 sm:flex-wrap sm:overflow-visible">
          {categories.map(cat => (
            <button
              ...
              className={`px-3 sm:px-4 py-1.5 text-[10px] sm:text-xs font-semibold tracking-[0.12em] transition-all border whitespace-nowrap shrink-0 sm:shrink ${
                activeCategory === cat
                  ? 'bg-[#C89B3C] text-[#141210] border-[#C89B3C]'
                  : 'bg-transparent text-[#EAE4D9]/60 border-transparent border-t-[#EAE4D9]/20 hover:border-[#C89B3C]/30 hover:text-[#C89B3C]'
              }`}
            >
              {cat}
            </button>
        ...
        <div className="border-t border-[#EAE4D9]/10 pt-4">
          <button
            ...
            className="flex items-center gap-2 text-xs font-semibold tracking-[0.12em] text-[#EAE4D9]/60 hover:text-[#EAE4D9] transition-colors"
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-4">
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  <label className="meta-eyebrow text-[#EAE4D9]">Max price</label>
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  <label className="meta-eyebrow text-[#EAE4D9]">Min proof</label>
              ...
              {filtersActive && (
                <button
                  ...
                  className="text-xs font-semibold tracking-[0.12em] text-[#C89B3C] hover:text-[#EAE4D9] transition-colors"
                >
                  Reset Filters
                </button>
              )}
      ...
      <div className="experience-meta">
        <div className="experience-meta-card flex items-center justify-end">
        <div className="flex items-center gap-2">
          <span className="meta-eyebrow text-[#EAE4D9]/40">Sort</span>
          <select
            value={sortBy}
            onChange={(e) => setSortBy(e.target.value)}
        ...
        <div className="experience-support-block">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {paginatedLiquors.length > 0 ? (
              ...
              <div className="col-span-full text-center py-20 space-y-6 experience-meta-card inset">
          ...
          {/* Pagination */}
          {totalPages > 1 && (
            <div className="experience-meta-card flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div>
              ...
              <div className="flex flex-wrap items-center justify-center gap-4">
                <button
                  ...
                  disabled={page === 1}
                  className="px-4 py-1.5 text-xs font-semibold tracking-[0.12em] transition-colors vintage-border text-[#C89B3C] hover:bg-[#C89B3C] hover:text-[#141210] hover:border-[#C89B3C] disabled:opacity-30 disabled:pointer-events-none"
                >
                  <Plus size={16} /> Add it to the database
                </button>
                <button
