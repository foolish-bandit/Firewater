    ...
    >
      ...
      <div className="p-6 flex-1 flex flex-col">
        <div className="flex items-start justify-between mb-2">
          <h3 className="font-serif text-2xl font-normal text-[var(--text-primary)] group-hover:text-[var(--text-accent)] transition-colors leading-tight flex-1 mr-3">{liquor.name}</h3>
        ...
        <p className="micro-label text-[var(--text-accent)] mb-3">{liquor.distillery}</p>
