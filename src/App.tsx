    ...
    return (
      <div className="min-h-screen bg-[#141210] flex items-center justify-center p-4">
        <div className="bg-[#1A1816] vintage-border p-6 md:p-10 max-w-lg w-full shadow-2xl text-center">
          ...
          <h1 className="font-display text-3xl md:text-4xl font-normal text-[#EAE4D9] mb-4">Welcome to FIREWATER</h1>
      ...
      <nav className={`sticky top-0 z-50 glass-surface vintage-border-b transition-all duration-300 ${scrolled ? 'shadow-[0_4px_30px_rgba(0,0,0,0.4)]' : ''}`} ref={mobileMenuRef}>
        <div className="max-w-5xl mx-auto px-4 h-20 flex items-center justify-between">
          ...
          >
            ...
            <span className="font-display text-2xl font-bold tracking-widest text-[#EAE4D9] uppercase">FIREWATER</span>
          </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[var(--color-vintage-bg)]/90 backdrop-blur-md animate-in fade-in duration-300" role="dialog" aria-modal="true" aria-label="Welcome to FIREWATER">
          <div className="bg-[#1A1816] vintage-border p-6 md:p-10 max-w-lg w-full elevated-high relative max-h-[90vh] overflow-y-auto">
            ...
            <div className="text-center mb-10 relative z-10">
              ...
              <h2 className="font-display text-4xl font-normal text-[#EAE4D9] mb-4">Welcome to FIREWATER</h2>
            ...
            <div className="space-y-8 relative z-10">
              <div className="flex gap-6 items-start">
                <div className="flex-shrink-0 w-10 h-10 rounded-full vintage-border flex items-center justify-center text-[#C89B3C] font-display text-xl">1</div>
                <div>
              ...
              <div className="flex gap-6 items-start">
                <div className="flex-shrink-0 w-10 h-10 rounded-full vintage-border flex items-center justify-center text-[#C89B3C] font-display text-xl">2</div>
                <div>
              ...
              <div className="flex gap-6 items-start">
                <div className="flex-shrink-0 w-10 h-10 rounded-full vintage-border flex items-center justify-center text-[#C89B3C] font-display text-xl">3</div>
                <div>
