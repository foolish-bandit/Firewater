        ...
        <div className="max-w-5xl mx-auto px-4 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex gap-6 items-center">
            ...
            <button
              ...
              className={`relative text-xs font-semibold tracking-widest uppercase transition-colors flex items-center gap-2 py-1 ${location.pathname === '/discover' ? 'text-on-surface-accent' : 'text-on-surface-muted hover:text-on-surface'}`}
            >
              <Crosshair size={14} /> Discover
              {location.pathname === '/discover' && <span className="absolute -bottom-1 left-1/2 -translate-x-1/2 w-1 h-1 rounded-full bg-on-surface-accent" />}
            </button>
            <button
            ...
            <button
              ...
              className={`relative text-xs font-semibold tracking-widest uppercase transition-colors flex items-center gap-2 py-1 ${location.pathname === '/compare' ? 'text-on-surface-accent' : 'text-on-surface-muted hover:text-on-surface'}`}
            >
              <GitCompareArrows size={14} /> Compare
              {location.pathname === '/compare' && <span className="absolute -bottom-1 left-1/2 -translate-x-1/2 w-1 h-1 rounded-full bg-on-surface-accent" />}
            </button>
            <button
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-surface-raised vintage-border-b px-4 pb-4 elevated-high relative z-50 animate-in slide-in-from-top-2 duration-200">
            ...
            <button
              ...
              className={`block w-full text-left text-sm font-semibold tracking-widest uppercase transition-colors py-4 border-b border-[var(--color-vintage-border)] flex items-center gap-2 ${location.pathname === '/discover' ? 'text-on-surface-accent' : 'text-on-surface-muted hover:text-on-surface-accent'}`}
            >
              <Crosshair size={14} /> Discover
            </button>
            <button
            ...
            <button
              ...
              className={`block w-full text-left text-sm font-semibold tracking-widest uppercase transition-colors py-4 border-b border-[var(--color-vintage-border)] flex items-center gap-2 ${location.pathname === '/compare' ? 'text-on-surface-accent' : 'text-on-surface-muted hover:text-on-surface-accent'}`}
            >
              <GitCompareArrows size={14} /> Compare
            </button>
            <button
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 glass-surface border-t border-[var(--color-vintage-border)] safe-bottom shadow-[0_-4px_20px_rgba(0,0,0,0.3)]">
        <div className="flex items-center justify-around h-[4.25rem]">
          ...
          {user ? (
            ...
            <button
              onClick={() => navigate('/compare')}
              className={`flex flex-col items-center justify-center gap-1 flex-1 h-full transition-colors ${location.pathname === '/compare' ? 'text-on-surface-accent' : 'text-on-surface-muted active:text-on-surface-secondary'}`}
            >
