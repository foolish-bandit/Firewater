...
export const ALL_RUM: Bourbon[] = [...RUM, ...RUM_VOL2, ...RUM_VOL3];

export const ALL_TEQUILA_MEZCAL: Bourbon[] = [...TEQUILA_MEZCAL, ...TEQUILA_MEZCAL_VOL2, ...TEQUILA_MEZCAL_VOL3];

export const ALL_BRANDY: Bourbon[] = [...BRANDY_COGNAC, ...BRANDY_COGNAC_VOL2, ...ARMAGNAC, ...ARMAGNAC_VOL2];

export const ALL_AMARO_LIQUEURS: Bourbon[] = [...LIQUEURS, ...LIQUEURS_VOL2, ...AMARO, ...AMARO_VOL2];
