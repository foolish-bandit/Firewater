...
export const SCOTCH: Liquor[] = [...SCOTCH_VOL1];

export const ALL_IRISH_WHISKEY: Bourbon[] = [...IRISH_WHISKEY, ...IRISH_WHISKEY_VOL2];

export const ALL_RYE: Bourbon[] = [...RYE_WHISKEY, ...RYE_WHISKEY_VOL2];

export const ALL_CANADIAN: Bourbon[] = [...CANADIAN_WHISKY, ...CANADIAN_WHISKY_VOL2];

export const ALL_JAPANESE_WORLD: Bourbon[] = [...JAPANESE_WHISKY, ...JAPANESE_WHISKY_VOL2];

export const ALL_VODKA: Bourbon[] = [...VODKA, ...VODKA_VOL2];

export const ALL_GIN: Bourbon[] = [...GIN, ...GIN_VOL2];
